...
const ReservationHeader = dynamic(
  () =>
    import("./components/ReservationHeader").then(
      (module) => module.ReservationHeader,
    ),
  {
...
const GuestDetailsCard = dynamic(
  () =>
    import("./components/GuestDetailsCard").then(
      (module) => module.GuestDetailsCard,
    ),
  {
...
const StayDetailsCard = dynamic(
  () =>
    import("./components/StayDetailsCard").then(
      (module) => module.StayDetailsCard,
    ),
  {
...
const LinkedReservationsCard = dynamic(
  () =>
    import("./components/LinkedReservationsCard").then(
      (module) => module.LinkedReservationsCard,
    ),
  {
...
const BillingCard = dynamic(
  () => import("./components/BillingCard").then((module) => module.BillingCard),
  {
    loading: () => <Skeleton className="h-96 w-full rounded-2xl" />,
  },
);

const ReservationActivityTimeline = dynamic(
  () =>
    import("./components/ReservationActivityTimeline").then(
      (module) => module.ReservationActivityTimeline,
    ),
  {
...
export function ReservationDetailsClient() {
  ...
  const bookingReservationsWithDetails: ReservationWithDetails[] = isolatedBookingReservations
    ...
    .map((entry) => {
      ...
      const entryRoomNumber =
        bookingLookupRooms.find((room) => room.id === entry.roomId)?.roomNumber || "N/A";
      return {
        ...entry,
  ...
  const fallbackReservationDetails: ReservationWithDetails = {
    ...
    roomNumber:
      bookingLookupRooms.find((r) => r.id === reservation.roomId)?.roomNumber || "N/A",
    nights: differenceInDays(
    ...
    <PermissionGate feature="reservations">
      <div className="space-y-6">
        <ReservationHeader
          ...
          guest={guest}
          bookingRooms={bookingLookupRooms}
          bookingRoomTypes={activeBookingRoomTypes}
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-1 space-y-6">
            ...
            <StayDetailsCard
              reservation={stayDetailsReservation}
              ratePlans={bookingLookupRatePlans}
            />
            <LinkedReservationsCard
              reservations={groupSummary.reservations}
              rooms={bookingLookupRooms}
              roomTypes={activeBookingRoomTypes}
            />
          </div>
